    ...
    export default {
        ...
        data() {
            return {
                ...
                items: [],
                // crud functions
                fetchLink: "specialties/list",
                deleteLink: "specialties/delete/",
                editRouteName: "Edit-Specialty",
                viewRouteName: "View-Specialty",
                componentData: [],
                // table properties
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body dynamic_table_card_body">
                        ...
                        <div v-if="$can('add_specialty')">
                            <NavigateTo routeName="Add-Specialty" routeLabel="Add Specialty"></NavigateTo>
                            <hr>
                        </div>
                        ...
                        <div class="mb-0 position-relative dynamic_table">
                            ...
                            >
                                ...
                                <template #cell(actions)="row">
                                    <div class="d-inline" v-if="$can('view_specialty')">
                                        <b-button
                                            size="sm"
                                    ...
                                    <ConfirmDelete
                                        ...
                                        permissionName="delete_specialty"
                                    ></ConfirmDelete>
                                </template>
                            </b-table>
