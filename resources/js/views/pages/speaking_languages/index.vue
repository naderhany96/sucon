    ...
    export default {
        ...
        data() {
            return {
                ...
                items: [],
                // crud functions
                fetchLink: "speaking_languages/list",
                deleteLink: "speaking_languages/delete/",
                editRouteName: "Edit-Speaking-Language",
                viewRouteName: "View-Speaking-Language",
                componentData: [],
                // table properties
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body dynamic_table_card_body">
                        ...
                        <div v-if="$can('add_speaking_language')">
                            <NavigateTo routeName="Add-Speaking-Language" routeLabel="Add Speaking Language"></NavigateTo>
                            <hr>
                        </div>
                        ...
                        <div class="mb-0 position-relative dynamic_table">
                            ...
                            >
                                <template #cell(isActive)="data">
                                    <div class="d-inline-block" v-if="data.item.isActive == 1">
                                        <b-badge pill variant="success">Active</b-badge>
                                    </div>
                                    <div class="d-inline-block" v-else>
                                        <b-badge pill variant="danger">Not Active</b-badge>
                                    </div>
                                </template>
                                <template #cell(actions)="row">
                                    <div class="d-inline" v-if="$can('view_speaking_language')">
                                        <b-button
                                            size="sm"
                                    ...
                                    <EditItem
                                        ...
                                        :editItem="editItem"
                                        permissionName="edit_speaking_language"
                                    ></EditItem>
                                    <ConfirmDelete
                                        :row="row" 
                                        ...
                                        permissionName="delete_speaking_language"
                                    ></ConfirmDelete>
                                </template>
                            </b-table>
