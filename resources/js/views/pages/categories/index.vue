    ...
    export default {
        ...
        data() {
            return {
                ...
                items: [],
                // crud functions
                fetchLink: "categories/list",
                deleteLink: "categories/delete/",
                editRouteName: "Edit-Category",
                viewRouteName: "View-Category",
                componentData: [],
                // table properties
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body dynamic_table_card_body">
                        ...
                        <div v-if="$can('add_category')">
                            <NavigateTo routeName="Add-Category" routeLabel="Add Category"></NavigateTo>
                            <hr>
                        </div>
                        ...
                        <div class="mb-0 position-relative dynamic_table">
                            ...
                            >
                                <template #cell(actions)="row">
                                    <div class="d-inline" v-if="$can('view_category')">
                                        <b-button
                                            size="sm"
                                    ...
                                    <ConfirmDelete
                                        ...
                                        permissionName="delete_category"
                                    ></ConfirmDelete>
                                </template>
                            </b-table>
