    ...
    export default {
        ...
        data() {
            return {
                ...
                items: [],
                // crud functions
                fetchLink: "age_groups/list",
                deleteLink: "age_groups/delete/",
                editRouteName: "Edit-Age-Group",
                viewRouteName: "View-Age-Group",
                componentData: [],
                // table properties
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body dynamic_table_card_body">
                        ...
                        <div v-if="$can('add_age_group')">
                            <NavigateTo routeName="Add-Age-Group" routeLabel="Add Age Group"></NavigateTo>
                            <hr>
                        </div>
                        ...
                        <div class="mb-0 position-relative dynamic_table">
                            ...
                            >
                                ...
                                <template #cell(actions)="row">
                                    <div class="d-inline" v-if="$can('view_age_group')">
                                        <b-button
                                            size="sm"
                                    ...
                                    <ConfirmDelete
                                        ...
                                        permissionName="delete_age_group"
                                    ></ConfirmDelete>
                                </template>
                            </b-table>
