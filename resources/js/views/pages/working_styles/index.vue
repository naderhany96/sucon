    ...
    export default {
        ...
        data() {
            return {
                ...
                items: [],
                // crud functions
                fetchLink: "working_styles/list",
                deleteLink: "working_styles/delete/",
                editRouteName: "Edit-Working-Style",
                viewRouteName: "View-Working-Style",
                componentData: [],
                // table properties
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body dynamic_table_card_body">
                        ...
                        <div v-if="$can('add_working_style')">
                            <NavigateTo routeName="Add-Working-Style" routeLabel="Add Working Style"></NavigateTo>
                            <hr>
                        </div>
                        ...
                        <div class="mb-0 position-relative dynamic_table">
                            ...
                            >
                                <template #cell(desc)="data">
                                    <p v-if="data.item.desc.length > 20">
                                        {{ data.item.desc.substring(0, 20) + " ..." }}
                                    </p>
                                    <p v-else>{{ data.item.desc }}</p>
                                </template>
                                <template #cell(actions)="row">
                                    <div class="d-inline" v-if="$can('view_working_style')">
                                        <b-button
                                            size="sm"
                                    ...
                                    <EditItem
                                        ...
                                        :editItem="editItem"
                                        permissionName="edit_working_style"
                                    ></EditItem>
                                    <ConfirmDelete
                                        :row="row" 
                                        ...
                                        permissionName="delete_working_style"
                                    ></ConfirmDelete>
                                </template>
                            </b-table>
