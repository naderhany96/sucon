...
export default {
    ...
    data() {
        return {
            ...
            items: [],
            // crud functions
            fetchLink: `doctor/groups/list/${this.$route.params.id}`,
            deleteLink: `doctor/groups/delete/${this.$route.params.id}/`,
            editRouteName: "Edit-Doctor-Group",
            viewRouteName: "View-Doctor-Group",
            componentData: [],
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body dynamic_table_card_body">
                        ...
                        <NavigateTo routeName="Add-Doctor-Group" routeLabel="Add Doctor Group"></NavigateTo>
                        <hr>
