    ...
    export default {
        ...
        data() {
            return {
                ...
                items: [],
                // crud functions
                fetchLink: "qualifications/list",
                deleteLink: "qualifications/delete/",
                editRouteName: "Edit-Qualification",
                viewRouteName: "View-Qualification",
                componentData: [],
                // table properties
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body dynamic_table_card_body">
                        ...
                        <div v-if="$can('add_qualification')">
                            <NavigateTo routeName="Add-Qualification" routeLabel="Add Qualification"></NavigateTo>
                            <hr>
                        </div>
                        ...
                        <div class="mb-0 position-relative dynamic_table">
                            ...
                            >
                                ...
                                <template #cell(actions)="row">
                                    <div class="d-inline" v-if="$can('view_qualification')">
                                        <b-button
                                            size="sm"
                                    ...
                                    <EditItem
                                        ...
                                        :editItem="editItem"
                                        permissionName="edit_qualification"
                                    ></EditItem>
                                    <ConfirmDelete
                                        :row="row" 
                                        ...
                                        permissionName="delete_qualification"
                                    ></ConfirmDelete>
                                </template>
                            </b-table>
