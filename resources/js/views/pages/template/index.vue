    ...
    export default {
        ...
        data() {
            return {
                ...
                // crud functions
                fetchLink: "tags/list",
                deleteLink: "tags/delete/",
                editRouteName: "Edit-Tag",
                viewRouteName: "View-Tag",
                componentData: [],
                // table properties
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body dynamic_table_card_body">
                        ...
                        <div v-if="$can('add_tag')">
                            <NavigateTo routeName="Add-Tag" routeLabel="Add Tag"></NavigateTo>
                            <hr>
                        </div>
                            ...
                            >
                                <template #cell(type)="data">
                                    <div class="d-inline-block">
                                        {{ _.startCase(data.item.type) }}
                                    </div>
                                </template>
                                <template #cell(actions)="row">
                                    <div class="d-inline" v-if="$can('view_tag')">
                                        <b-button
                                            size="sm"
