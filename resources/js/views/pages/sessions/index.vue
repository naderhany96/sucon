    ...
    export default {
        ...
        data() {
            return {
                ...
                items: [],
                // crud functions
                fetchLink: "sessions/list",
                deleteLink: "sessions/delete/",
                editRouteName: "Edit-Session",
                viewRouteName: "View-Session",
                componentData: [],
                // table properties
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body dynamic_table_card_body">
                        ...
                        <div v-if="$can('add_session')">
                            <NavigateTo routeName="Add-Session" routeLabel="Add Session"></NavigateTo>
                            <hr>
                        </div>
                        ...
                        <div class="mb-0 position-relative dynamic_table">
                            ...
                            >
                                ...
                                <template #cell(actions)="row">
                                    <div class="d-inline" v-if="$can('view_session')">
                                        <b-button
                                            size="sm"
