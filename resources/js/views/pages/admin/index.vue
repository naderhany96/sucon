    ...
    export default {
        ...
        data() {
            return {
                ...
                items: [],
                // crud functions
                fetchLink: "admins/list",
                deleteLink: "admins/delete/",
                editRouteName: "Edit-Admin",
                viewRouteName: "View-Admin",
                componentData: [],
                // table properties
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body dynamic_table_card_body">
                        ...
                        <div v-if="$can('add_admin')">
                            <NavigateTo routeName="Add-Admin" routeLabel="Add Admin"></NavigateTo>
                            <hr>
                        </div>
                        ...
                        <div class="mb-0 position-relative dynamic_table">
                            ...
                            >
                                ...
                                <template #cell(actions)="row">
                                    <div class="d-inline" v-if="$can('view_admin')">
                                        <b-button
                                            size="sm"
